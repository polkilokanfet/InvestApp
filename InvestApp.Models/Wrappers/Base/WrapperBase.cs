...
namespace InvestApp.Models.Wrappers.Base
{
        ...
        where TModel : class, IBaseEntity
    {
        ...
        /// </summary>
        public virtual bool IsChanged => _originalValues.Count > 0 || _trackingObjects.Any(trackingObject => trackingObject.IsChanged);

        /// <summary>
        /// Все ли свойства валидны.
        /// </summary>
        public virtual bool IsValid => !HasErrors && _trackingObjects.All(trackingObject => trackingObject.IsValid);
